...
namespace EnhancedScrollerDemos.SuperSimpleDemo
{
    ...
    public class SimpleDemo : MonoBehaviour, IEnhancedScrollerDelegate
    {
        ...
        /// </summary>
        private static SmallList<Data> _data;
        ...
        IEnumerator GetRanking()
        {
            ...
            UnityWebRequest www = UnityWebRequest.Post("https://night-at-cemetery.herokuapp.com/rank", form);
            ...
            {
                JArray result = JArray.Parse(www.downloadHandler.text);
                ...
                foreach (var r in result)
                {
                    ...
                    {
                        level = i,
                        playerName = (string) r["name"] + "#" + r["id"],
                        playerScore = (int) r["score"]
                    });
                    i += 1;
                }
